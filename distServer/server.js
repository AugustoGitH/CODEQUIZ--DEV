...
const Authentication_1 = __importDefault(require("./routers/public/Authentication"));
const VerifyToken_1 = __importDefault(require("./routers/public/VerifyToken"));
const user_1 = __importDefault(require("./routers/user"));
const Quiz_1 = __importDefault(require("./routers/public/Quiz"));
...
app.use('/api/v/token', VerifyToken_1.default);
