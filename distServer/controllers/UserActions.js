...
const UserActions_1 = require("../db/schemas/UserActions");
...
exports.default = {
    creatingQuiz(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { error } = (0, UserActions_1.schemaCratingQuiz)(quiz);
            if (error)
    ...
    getQuizesCreateBy(req, res) {
        ...
        Verifique o console. error: ${resCreatorId.error}`);
          ...
          Tente novamente ou consulte o desenvolvedor.`
                ...
                const quizes = yield Quiz_1.default.find({
                    creatorId: resCreatorId.idCreator
                });
                res.status(200).send({
                    message: "Quizes resgatados com sucesso!", data: quizes
                });
            }
            catch (error) {
                console.log(`Ocorreu um erro ao criar o quiz. error: ${error}`);
