...
exports.default = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const passwordCryptoMath = userSearch ?
                    bcrypt_1.default.compare(password, userSearch.password) : null;
                ...
                res.status(200)
                    .cookie(((_b = process.env) === null || _b === void 0 ? void 0 : _b.NAME_TOKEN_AUTORIZATION)
                    || "tokenAuthorization", tokenJWT, {
                    secure: true,
                    httpOnly: true
                }).send({
                ...
                console.log(e);
                res.status(500).send({
                    message: `Ocorreu um erro inesperado internamente no servidor. 
    ...
    register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Verifique se nenhum dos valores passado é indefinido ou nulo.`
                });
            ...
            try {
                ...
                const passwordCrypto = bcrypt_1.default.hashSync(password, 10);
                const newUser = yield new User_1.default({
                    name, email, password: passwordCrypto
                }).save();
                res.status(201).send({
                    message: `Bem vindo ${newUser.name}! Seu registro
    ...
    logout(_req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(`Erro interno do servidor: ${e}`);
                res.status(500).send({
                    message: `Houve um erro interno no servidor ao fazer logout! 
